...
export const photoService = {
  ...
  getMyPhotos: (limit = 50) => api.get('/photos/mine', { params: { limit } }),
  uploadPhoto: (formData) => api.post('/upload', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
...
export const adminService = {
  ...
  resolveCommentReport: (reportId, action, adminNote) => api.post(`/admin/comment-reports/${reportId}/resolve`, { action, adminNote }),
};
