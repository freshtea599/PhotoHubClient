      ...
      <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
          <template v-if="authStore.isAuthenticated">
            <div class="relative" ref="menuRoot">
              <button
                ...
                title="Профиль"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-gray-700">
              ...
              >
                <router-link to="/profile" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 transition" @click="closeMenu">
                  👤 Профиль
                </router-link>
                <router-link to="/gallery" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 transition border-t" @click="closeMenu">
                  🖼️ Галерея
                </router-link>
                <router-link to="/upload" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 transition border-t" @click="closeMenu">
                  📤 Загрузить фото
                </router-link>
                <router-link
          ...
          <template v-else>
            ...
            <router-link to="/register" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium transition">
              Зарегистрироваться
            </router-link>
          </template>
        </div>
